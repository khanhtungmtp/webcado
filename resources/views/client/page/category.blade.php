                    ...
                    <div class="post-block-style post-list clearfix">
                        <div class="row">
                            <div class="col-lg-5 col-md-6">
                                <div class="post-thumb thumb-float-style">
                                    <a href="#">
                                        <img class="img-fluid" src="frontend/images/news/tech/game2.jpg" alt="" />
                                    </a>
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="post-content">
                                    <h2 class="post-title title-large">
                                        <a href="#">Lindie game plonks players in front of huge starship command center</a>
                                    </h2>
                                    <div class="post-meta">
                                        <span class="post-author"><a href="#">John Doe</a></span>
                                        <span class="post-date">Feb 24, 2017</span>
                    ...
                    <div class="post-block-style post-list clearfix">
                        <div class="row">
                            <div class="col-lg-5 col-md-6">
                                <div class="post-thumb thumb-float-style">
                                    <a href="#">
                                        <img class="img-fluid" src="frontend/images/news/tech/robot3.jpg" alt="" />
                                    </a>
                                    <a class="post-cat" href="#">Robotics</a>
                                </div>
                            </div><!-- Img thumb col end -->
                    ...
                    <div class="post-block-style post-list clearfix">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="post-content">
                                    <h2 class="post-title title-large">
                                        <a href="#">Historical heroes and robot dinosaurs: New games on our radar in April</a>
                                    </h2>
                                    <div class="post-meta">
                                        <span class="post-author"><a href="#">John Doe</a></span>
                                        <span class="post-date">Feb 24, 2017</span>
